...
urlpatterns = [
    ...
    path('cjfh/xzlt2019.pdf', views.download_cjfh, name='index'),
    ...
    # path('set_config_2', views.set_config_2, name='set_config'),
    # path('set_config_3', views.set_config_3, name='set_config'),
    # path('set_config_4', views.set_config_4, name='set_config'),
    path('upload/', views.set_invoice),
    # path('upload-invoice/', views.set_invoice),
    path('clientInfo/', views.client_info),
    path('personalIncomeTax/', views.set_personalIncomeTax),
    path('requisition/', views.set_requisition),
    path('base/', views.base),
    path('copInfo/', views.rec_excel),
