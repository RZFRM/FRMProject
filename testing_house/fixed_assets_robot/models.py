...
class FA_purchase_requisition_table(models.Model):
    ...
    procurement_type = models.CharField(max_length=50, null=True, verbose_name='采购类型')

    def __str__(self):
        return self.purchase_usesing

    class Meta:
        db_table = 'FA_purchase_requisition_table'
...
# # # TODO   采购合同机器人数据表
# #
class FA_purchase_order_table(models.Model):
    id = models.AutoField(primary_key=True, verbose_name="id")
    ...
    class Meta:
        db_table = 'FA_purchase_order_table'


# TODO   采购入库机器人数据表

class FA_purchase_storage_table(models.Model):
    id = models.AutoField(primary_key=True, verbose_name="id")
    gmt_create = models.DateTimeField(null=True, verbose_name='创建时间')
    gmt_modified = models.DateTimeField(null=True, verbose_name='修改时间')
    ...
    class Meta:
        db_table = 'FA_purchase_storage_table'
...
class FA_purchase_invoice_table(models.Model):
    id = models.AutoField(primary_key=True, verbose_name="id")
    user_name = models.CharField(max_length=20, null=True, verbose_name='用户名')
    gmt_create = models.DateTimeField(null=True, verbose_name='创建时间')
    gmt_modified = models.DateTimeField(null=True, verbose_name='修改时间')
    ...
    class Meta:
        db_table = 'FA_purchase_invoice_table'
...
# # TODO   采购付款机器人数据表
#
class FA_purchase_payment_table(models.Model):
    id = models.AutoField(primary_key=True, verbose_name="id")
    user_name = models.CharField(max_length=20, null=True, verbose_name='用户名')
    gmt_create = models.DateTimeField(null=True, verbose_name='创建时间')
    gmt_modified = models.DateTimeField(null=True, verbose_name='修改时间')
    ...
    class Meta:
        db_table = 'FA_purchase_payment_table'
